...
public class Playdate1 : NSObject {
    ...
    public class func drawProfile(#frame: CGRect) {
        ...
        //// Oval Drawing
        var ovalPath = UIBezierPath(ovalInRect: CGRectMake(frame.minX + floor(frame.width * 0.36800 + 0.5), frame.minY + floor(frame.height * 0.09295 + 0.5), floor(frame.width * 0.63467 + 0.5) - floor(frame.width * 0.36800 + 0.5), floor(frame.height * 0.24288 + 0.5) - floor(frame.height * 0.09295 + 0.5)))
